...
class TransitionMatrixBiasedSamplerRev(object):
    ...
    def _update_Metzner_MC_nofail(self, n_step, FW):
        ...
        Also, it draws the moves at random, instead of iterating through all possible changeable elements
        """
    ...
    def _update_Metzner_MC_fixedstep(self, n_step, FW):
        ...
        #fp = open('./EW_data_test_lamb-'+str(self.lamb)+'.dat', 'w+') # for Debugging
        #fp.write(something) # for Debugging
    ...
    def _update_Metzner_MC_fixedstep_corrmove(self, n_step, FW):
        ...
        #fp = open('./test_data_lamb-'+str(self.lamb)+'.dat', 'w+') # for Debugging
        #fp.write(something) # for Debugging
    ...
    def sample(self, n_step, T_init = None, X_init = None, EQ_CG = None, EQ_AA = None, F_fun = None, F_CG = None, beta = None, lamb = None, fixed_pi = False):
        ...
        # other samplers, old or not ready
